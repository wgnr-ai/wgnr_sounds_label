# A&R (Artist & Repertoire) — Context

> Project-scoped context for the `ar` agent profile.
...
Signed recording agreements; A&R briefs (including Suno-role declaration); demo review logs; quarterly A&R activity reports; canonical roster snapshot.
