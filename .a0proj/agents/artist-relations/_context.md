# Artist Relations — Context

> Project-scoped context for the `artist-relations` agent profile.
...
Artist communication logs; check-in notes; conflict-resolution memos; tour coordination plans.
