# Operations / Label Management — Context

> Project-scoped context for the `operations` agent profile.
> Last updated: 2026-08-30 (v2.0.0)

## Department Function

The glue. Owns inter-department workflow, the release calendar, the budget envelope, and the reporting cadence.
...
Release calendar; weekly / monthly operating reports; per-release budget approvals; inter-department workflow templates.
...
- All 9 other departments + Principal (Wagner dos Santos)
