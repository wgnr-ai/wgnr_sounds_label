...
WGNR Sounds is a **division of WGNR** (parent-child relationship). The PRD references:

- The local brand assets path at `.a0proj/knowledge/client-assets/wgnr-sounds-assets/` (scaffolded for Wagner's handoff).
...
- Brand references use the WGNR Sounds brand guide (local path) — NOT the wgnr.ai parent color palette.
